...
- `vector_store`: Specifies the vector database provider and its configuration
  - `provider`: The name of the vector database (e.g., "chroma", "pgvector", "qdrant", "milvus", "upstash_vector", "azure_ai_search", "vertex_ai_vector_search", "valkey", "tencent_vectordb")
...
| `database_name` | Name of the database (for Tencent VectorDB/Baidu VectorDB) |
| `table_name` | Name of the table (for Baidu VectorDB) |
| `account` | Account name (for Baidu VectorDB) |
| `endpoint` | Endpoint URL (for Baidu VectorDB) |
| `key` | API key (for Tencent VectorDB) |
| `timeout` | Connection timeout in seconds (for Tencent VectorDB) |
</Tab>
